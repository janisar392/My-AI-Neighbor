        ...
        <div className="container mx-auto px-8">
            <div className="bg-[#E4D6C8] rounded-2xl p-12 text-center flex flex-col items-center">
                ...
                <p className="text-gray-600 max-w-2xl mb-8">
                    Join thousands of artists and Studio Ghibli fans who are creating stunning Miyazaki-inspired artwork with our My AI Neighbor generator.
                </p>
