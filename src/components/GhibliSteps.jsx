        ...
        <div className="rounded-lg flex flex-col lg:flex-row items-center lg:items-start gap-8 container mx-auto px-8 pb-16">
            <div className="lg:w-1/2 order-2 lg:order-1">
                ...
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base mb-6">
                    Transform any photo into beautiful Studio Ghibli-style artwork with our My AI Neighbor.
                ...
                <ul className="space-y-4">
                    <li className="flex items-start">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-800 text-md sm:text-lg">Simple My AI Neighbor Prompting</h3>
                            <p className="text-gray-600 text-sm">
                                Use everyday language to guide the Studio Ghibli transformation with our Ghibli
                                generator. No artistic background required. Our My AI Neighbor translates your vision into
                    ...
                    <li className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">
                                Our My AI Neighbor can seamlessly integrate your pets or family members into the Studio
